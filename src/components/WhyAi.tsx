  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-6 relative w-full aspect-square max-w-[450px] mx-auto border border-white/10 p-4 rounded-2xl">
          <div className="absolute top-2 left-2 text-[8px] font-mono text-zinc-400 uppercase tracking-widest z-20">
            pixxelu // generative mesh active
          </div>

          {/* Glowing Animated Mesh Container */}
          <div className="w-full h-full relative overflow-hidden bg-white/5 border border-white/5 rounded-xl shadow-md flex items-center justify-center">
            ...
            {/* Glowing spot 1 */}
            <div className="mesh-glow-1 absolute -top-12 -left-12 w-[260px] h-[260px] bg-orange/[0.08] rounded-full blur-[65px] mix-blend-screen pointer-events-none" />
            {/* Glowing spot 2 */}
            <div className="mesh-glow-2 absolute -bottom-16 -right-16 w-[320px] h-[320px] bg-orange/[0.05] rounded-full blur-[80px] mix-blend-screen pointer-events-none" />
            {/* Glowing spot 3 */}
            <div className="mesh-glow-1 absolute top-1/4 right-1/4 w-[200px] h-[200px] bg-white/[0.02] rounded-full blur-[60px] pointer-events-none" />
            ...
            <svg className="grid-rot absolute inset-0 w-full h-full opacity-30 pointer-events-none scale-110 text-white" viewBox="0 0 100 100">
            ...
            <div className="relative z-10 text-center flex flex-col items-center justify-center p-6 space-y-2">
              ...
              <span className="text-xs text-zinc-400 max-w-[220px]">
                Boilerplate automation matches with custom human inspection.
              </span>
            </div>

            {/* Interactive Corner Crosshairs */}
            <div className="absolute top-4 right-4 text-[9px] text-zinc-500 font-mono">+</div>
            <div className="absolute bottom-4 left-4 text-[9px] text-zinc-500 font-mono">+</div>
            <div className="absolute top-4 left-4 text-[9px] text-zinc-500 font-mono">+</div>
            <div className="absolute bottom-4 right-4 text-[9px] text-zinc-500 font-mono">+</div>
          </div>
        </div>
